...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/RRoberts12Seneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46101  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Rroberts12Seneca'  \-\-env DOCKERUSERNAME='rroberts87'  \-\-env MQTTUSERNAME='rroberts87'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   docker run -d -p 51213:51213 -p 57197:57197 -p 47089:47089 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cyt160cybersecurityprojectgr2-4651 \-\-env SOLUTIONDAG=solution_preprocessing_dag_mqtt-cyt160cybersecurityprojectgr2-4651 \-\-env GITUSERNAME=Rroberts12Seneca  \-\-env GITREPOURL=https://github.com/RRoberts12Seneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=51213  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=57197  \-\-env SOLUTIONVIPERVIZPORT=47089 \-\-env DOCKERUSERNAME='rroberts87' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=46101 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='rroberts87' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  rroberts87/cyt160cybersecurityprojectgr2-4651-amd64
...
.. important::
   solution_preprocessing_dag_mqtt-cyt160cybersecurityprojectgr2-4651
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=51213, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43815, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37511, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40933, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46345, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41195, HPDEHOST=127.0.1.1, HPDEPORT=38763, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46663

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7890-cyt160cybersecurityprojectgr2-4651,solution_preprocessing_dag_mqtt-cyt160cybersecurityprojectgr2-4651, python-preprocess-4241-cyt160cybersecurityprojectgr2-4651,solution_preprocessing_dag_mqtt-cyt160cybersecurityprojectgr2-4651, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
